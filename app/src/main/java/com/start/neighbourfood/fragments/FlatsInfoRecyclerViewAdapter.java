...
public class FlatsInfoRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
     ...
     */
    public FlatsInfoRecyclerViewAdapter(RecyclerViewClickListener listener, List<FlatsInfo> dataSet) {
